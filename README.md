...
|------|--------------|----------------------------|------------------------|-----------------------|
| **FMV: FRAM Model Visualiser** | Visual model creation, syntactic and consistency checking, cycle-by-cycle interpretation through FMI, and metadata-based quantitative simulation | Progressive Web App; modern browser; offline-installable; Blazor WebAssembly and .NET 8.0 | [Access the FMV Community Edition](https://github.com/functionalresonance/FMV_Community_Edition) · [Access the FMV Sandbox Version](https://github.com/functionalresonance/FMV_Analysis_Sandbox)| Hill, R., & Hollnagel, E. (2023). *Instructions for use of the FRAM Model Visualiser (FMV).* [View documentation](https://github.com/functionalresonance/FMV_Community_Edition) |
